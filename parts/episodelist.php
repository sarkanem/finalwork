...
<div class="container-fluid">
    ...
    <div id="all-episodes">
        ...
        <span><img src="images/ep1.jpg" width=20% height=20% class="rounded float-left" />
            ...
            <p class="list-group-item-text"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore in
                ...
                delectus earum reprehenderit nobis quod aliquid molestias veritatis! Lorem ipsum, dolor sit amet consectetur adipisicing elit. Labore in
                distinctio sequi eligendi accusamus asperiores voluptatibus, debitis veniam quod minus! Perspiciatis inventore
                delectus earum reprehenderit nobis quod aliquid molestias veritatis!</p>     
        </div>
        <div class="list-group">
  ...
  <nav aria-label="Episode pagination">
    ...
    <!-- here jquery will add the appropriate number of pages -->
    </ul>
  </nav>
