google.maps.event.addDomListener(window, 'load', init);
    ...
    function init() {
        var mapOptions = {
            center: new google.maps.LatLng(47.638467, -122.376592),
            zoom: 11,
            zoomControl: true,
            zoomControlOptions: {
        ...
        var locations = [
['Seattle Animal Shelter', 'Seattle Washington, USA', 47.638467, -122.376592, 'https://i.imgur.com/VjGH8E1.png']
        ];
...
link = '';            bindInfoWindow(marker, map, locations[i][0], description);
     }
      ...
      var infoWindowVisible = (function () {
           ...
           google.maps.event.addListener(marker, 'click', function() {
               if (infoWindowVisible()) {
                   ...
                   var html= "<div style='color:#000;background-color:#fff;padding:5px;width:200px;'><h5>"+title+"</h5><p>"+desc+"<p></div>";
